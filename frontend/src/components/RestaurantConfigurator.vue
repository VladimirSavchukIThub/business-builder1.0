<template>
  <div class="configurator">
    <h1>Конфигуратор Ресторана</h1>
    <p>Настройки ресторана</p>

    <div class="input-container">
      <label for="tableCount">Количество столов:</label>
      <input type="number" id="tableCount" v-model="tableCount" min="1" />
    </div>

    <div class="input-container">
      <label for="cookingArea">Количество мест для готовки:</label>
      <input type="number" id="cookingArea" v-model="cookingArea" min="1" />
    </div>

    <div class="input-container">
      <label for="fridgeCount">Количество холодильников:</label>
      <input type="number" id="fridgeCount" v-model="fridgeCount" min="1" />
    </div>
...
export default {
  ...
  computed: {
    totalPrice() {
      let price = this.basePrice + this.tableCount * 20000 + this.cookingArea * 30000 + this.fridgeCount * 25000;
      return price;
    }
  },
  methods: {
